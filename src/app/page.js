...
export default function Home() {
  return (
    <main className="">
      ...
      <h1 className="md:text-[30px] text-center text-xl md:leading-[40px] leading-[30px] font-bold py-4">TOP FEATURES</h1>
      ...
      <section className="flex flex-wrap justify-between py-[7%] px-[5%]">
        <div className="md:w-[30%] flex flex-col md:items-center md:p-[2%] p-4 my-4 rounded  bg-gradient-to-b from-primary/[0.05] to-dark/[0.05]  border border-gray-300/[0.2]">
            ...
            <h2 className='md:text-2xl text-lg font-semibold my-4 md:text-center'>Tailored Recommendations</h2>
        ...
        <div className="md:w-[30%] flex flex-col md:items-center md:p-[2%] p-4 my-4 rounded  bg-gradient-to-b from-primary/[0.05] to-dark/[0.05]  border border-gray-300/[0.2]">
            ...
            <h2 className='md:text-2xl text-lg font-semibold my-4 md:text-center'>Seamless User Experience</h2>
        ...
        <div className="md:w-[30%] flex flex-col md:items-center md:p-[2%] p-4 my-4 rounded  bg-gradient-to-b from-primary/[0.05] to-dark/[0.05]  border border-gray-300/[0.2]">
            ...
            <h2 className='md:text-2xl text-lg font-semibold my-4 md:text-center'>Customized Alerts</h2>
      ...
      <section className='px-[5%] py-[30px] md:flex justify-center bg-slate-200/[0.05]'>
        <div className='md:max-w-[60%]'>
          <p className="opacity-[0.8] text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-primary text-sm">PERSONALIZED AND USER-CENTERED</p>
          ...
          <div className='leading-[25px] py-2 pb-6'>
            <p className='flex items-center gap-2 py-2'><FaCheckCircle className='text-fuchsia-500' /> <span>Research Customization Profile</span></p>
            <p className='flex items-center gap-2 py-2'><FaCheckCircle className='text-fuchsia-500' /> <span>Email Paper Delivery</span></p>
            <p className='flex items-center gap-2 py-2'><FaCheckCircle className='text-fuchsia-500' /> <span>Research Paper Recommendation</span></p>
          </div>
        </div>
