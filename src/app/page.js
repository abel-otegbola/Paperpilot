  ...
  return (
    <main className="px-[5%] min-h-[500px] bg-[url('/bg.svg')] bg-cover">
      <header className="flex flex-col items-center justify-center py-[7%] md:px-[7%]">
        ...
        <Link className="px-[30px] py-[12px] sm:w-auto w-full text-center rounded bg-gradient-to-b from-fuchsia-600 to-primary text-white hover:from-primary hover:to-primary" href="/signup">Get Started</Link>
      </header>
    </main>
  )
}
