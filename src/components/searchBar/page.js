    ...
    return (
        <div className="border border-slate-400/[0.2] px-2">
            <div className="flex items-center p-2">
                ...
                <p className="p-[10px] px-6 rounded border border-slate-400/[0.3] bg-gradient-to-b from-fuchsia-600 to-primary text-white rounded cursor-pointer" onClick={handleSearch}>Search</p>
            </div>
