...
const SearchBar = ({ search, type, url }) => {
    ...
    return (
        <form ref={menuRef} className="border border-slate-400/[0.2] px-2 backdrop-blur-sm bg-white/[0.6] dark:bg-dark/[0.6]" action={`/search`}>
            <div className="flex items-center p-2">
                ...
                <input type="search" name="search" placeholder="Search papers..." defaultValue={search} onFocus={() => setOpen(true)} className="flex-1 bg-transparent border-transparent p-3 rounded flex-1 focus:outline-2 focus:outline-primary hover:border-primary" />
            ...
            <div className={`overflow-hidden transition-all duration-700 ${open ? "md:h-[120px] h-[190px]" : "h-[0px]"}`}>
                ...
                <div className="flex flex-wrap items-center w-full mb-2 p-2 gap-2 bg-gray-400/[0.1]">
                    <div className="border border-transparent border-l-gray-500/[0.1] px-2">
                        ...
                        <select className="p-2 px-4 border dark:bg-dark border-slate-400/[0.3] rounded cursor-pointer mr-1" defaultValue={type} name="type">
                            <option>paper</option>
                    ...
                    <div className="border border-transparent border-l-gray-500/[0.1] px-2">
                        ...
                        <select className="p-2 px-4 dark:bg-dark border border-slate-400/[0.3] rounded cursor-pointer mr-1" defaultValue={url} name="url">
